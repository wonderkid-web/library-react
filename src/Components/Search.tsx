    ...
    return (
        <section className="flex justify-center min-h-screen">
            <div className="search-query flex my-2 absolute justify-center items-center mt-20 w-full gap-5">
                <input type="text" placeholder="name of your book then press enter or click search" onChange={(e) => setQuery(e.target.value)} onKeyPress={handleKeyPress}
                    className="input w-1/2 shadow-md bg-white p-7" autoFocus />
            ...
            <div className="p-4 flex flex-col justify-start mt-40">
                <div className="p-12 flex gap-10 mb-[-50px]">
                    ...
                    {
                        total && <h1 className="flex justify-center items-center text-lg font-bold p-2 text-white rounded-lg bg-warning w-fit">Total : {total}</h1>
                    }
                </div>
                {
                    total == undefined ? <h1 className="btn">Your book is not found! or u just miss type ?</h1> : (
                        ...
                        <div>
                            ...
                            <div className="overflow-x-auto p-12">
                                <h1 className="text-center text-xl col-span-3 my-2 font-bold">Maybe you are interested in this?</h1>
                                            ...
                                            return (
                                                <div key={book.id} className="w-[250px] carousel-item">
                                                    <div className="card card-compact bg-white shadow-xl">
                                                        <figure><img className="w-[250px] h-[300px]" src={book.image} alt="Shoes" /></figure>
