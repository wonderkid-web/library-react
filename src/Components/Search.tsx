...
import { DeletedBook } from "./RootLayout";
                ...
                {total === undefined ? (
                    ...
                    <div>
                        <div className="overflow-x-auto w-3/4 mx-auto">
                            <table className="table table-zebra w-full rounded-md p-4  shadow-md bg-white">
                                <thead>
                                    ...
                                    {books
                                        ...
                                        .map((book: BookType) => (
                                            <tr key={book.id} className="text-center">
                                                ...
                                                <td>{book.title}</td>
                                                <th>
                                                    <Link to={`/bookProfile/${book.bookId}`}>
                                                        <button className="btn font-bold bg-yellow-500 hover:scale-110 pointer text-white">
                                                            details
                                                        </button>
                                                    </Link>
                                                </th>
