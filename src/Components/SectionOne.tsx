...
export default function SectionOne() {
  return (
    <div className="w-full h-[99vh]">
      <Navbar />
      <section className="flex h-full w-full gap-40 justify-evenly items-center bg-[#fdf9f3] border-b">
        <div className="flex flex-col p-5">
          <div className="flex gap-5">
            <span className="font-poppins text-[80px] font-bold">Get Your</span>
            <img
              src="Bulat.svg"
          ...
          <span className="rotate-[-90deg] relative right-[29%] mt-16 text-[27px] font-bold border-t border-[#FDD4B7] w-max text-gray-500 top-5">
